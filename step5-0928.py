    ...
    if 'true':
        ...
        for day in [1, 2, 3]:
            ...
            if len(np.unique(y)) == 1:
                ...
                DF2=pd.DataFrame([[pest_name, city_name, day, y[0], "-2", '0', "0"]], columns=column)
                DF = DF.append(DF2, ignore_index=True)
                continue
			...
			window.onload = function(){
					...
					if (plusBtn_1){
						...
						var my_table = "<div id='tablePrint'>";
							...
							my_table += "<tr><td>預測率</td><td>"+sub_table[0][4]+"</td><td>"+sub_table[1][4]+"</td><td>"+sub_table[2][4]+"</td></tr>";
                            my_table += "<tr><td>第二可能規模</td><td>"+sub_table[0][5]+"</td><td>"+sub_table[1][5]+"</td><td>"+sub_table[2][5]+"</td></tr>";
                            my_table += "<tr><td>預測率</td><td>"+sub_table[0][6]+"</td><td>"+sub_table[1][6]+"</td><td>"+sub_table[2][6]+"</td></tr></table>";
